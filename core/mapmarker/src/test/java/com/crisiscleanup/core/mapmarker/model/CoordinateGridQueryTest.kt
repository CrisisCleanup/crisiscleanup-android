...
class CoordinateGridQueryTest {
    ...
    fun coordinatesToTileCoordinates() {
        val expectedLookup = mapOf(
            ...
            Pair(75, -135) to Pair(0.0, 0.4183929676773679),
            Pair(75, -130) to Pair(0.11111111111111112, 0.4183929676773679),
            Pair(75, -125) to Pair(0.22222222222222224, 0.4183929676773679),
            Pair(75, -120) to Pair(0.33333333333333337, 0.4183929676773679),
            Pair(75, -115) to Pair(0.4444444444444445, 0.4183929676773679),
            Pair(75, -110) to Pair(0.5555555555555556, 0.4183929676773679),
            Pair(75, -105) to Pair(0.6666666666666667, 0.4183929676773679),
            Pair(75, -100) to Pair(0.7777777777777778, 0.4183929676773679),
            Pair(75, -95) to Pair(0.888888888888889, 0.4183929676773679),
            Pair(75, -90) to Pair(1.0, 0.4183929676773679),
        )
