...
class CasesMapBoundsManager(
    ...
    val mapCameraBounds = mapCameraBoundsInternal.asStateFlow()
        ...
        combine(
            ...
            .onEach { (_, ib, sb) ->
                ...
                if (bounds != zeroBounds) {
                    ...
                    mapCameraBoundsInternal.value = MapViewCameraBounds(bounds, 0)
                }
            }
        ...
        combine(
            ...
            .onEach { (_, ib) ->
                if (isStarted && ib != zeroBounds) {
                    cacheBounds(ib, true)
                    mapCameraBoundsInternal.value = MapViewCameraBounds(ib)
                }
            }
            .launchIn(coroutineScope)
    ...
    fun restoreIncidentBounds() {
        ...
        incidentBoundsProvider.getIncidentBounds(incidentId)?.let {
            mapCameraBoundsInternal.value = MapViewCameraBounds(it.bounds)
        }
    }
}
