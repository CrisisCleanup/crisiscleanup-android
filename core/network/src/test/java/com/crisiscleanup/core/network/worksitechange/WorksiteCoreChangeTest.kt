...
class WorksiteCoreChangeTest {
    ...
    private val baseSnapshot = testCoreSnapshot(
        ...
        phone1Notes = "phone-notes-snapshot",
    ...
    fun singleChange() {
        ...
        val expected = NetworkWorksitePush(
            ...
            phone1Notes = fullyDefinedWorksite.phone1Notes,
            phone2 = fullyDefinedWorksite.phone2 ?: "",
            phone2Notes = fullyDefinedWorksite.phone2Notes,
    ...
    fun minChanges() {
        val changeSnapshot = testCoreSnapshot(
            ...
            name = "name-change",
            phone1 = "phone-change",
            phone1Notes = "phone-notes-change",
        ...
        val expected = NetworkWorksitePush(
            ...
            phone1Notes = changeSnapshot.phone1Notes,
            phone2 = fullyDefinedWorksite.phone2 ?: "",
            phone2Notes = fullyDefinedWorksite.phone2Notes,
            plusCode = fullyDefinedWorksite.plusCode,
    ...
    fun fullChanges() {
        val changeSnapshot = testCoreSnapshot(
            ...
            phone2Notes = "phone2-notes-change",
        ...
        val expected = NetworkWorksitePush(
            ...
            phone2Notes = changeSnapshot.phone2Notes,
