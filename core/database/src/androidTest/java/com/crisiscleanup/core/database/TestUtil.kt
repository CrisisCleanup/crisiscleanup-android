...
object TestUtil {
    ...
    fun testUuidGenerator(): UuidGenerator = spyk(
    ...
    fun testChangeSerializer(): WorksiteChangeSerializer =
        spyk(
            object : WorksiteChangeSerializer {
    ...
    fun testAppVersionProvider(): AppVersionProvider = spyk(
    ...
    fun testAppLogger(): AppLogger = spyk(
        object : AppLogger {
    ...
    fun testSyncLogger(): SyncLogger = spyk(
        object : SyncLogger {
