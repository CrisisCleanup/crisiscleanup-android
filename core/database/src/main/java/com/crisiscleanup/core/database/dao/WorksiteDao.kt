...
interface WorksiteDao {
    ...
    @Query(
        ...
        phone1_notes    =COALESCE(:phone1Notes, phone1_notes),
        phone2          =COALESCE(:phone2, phone2),
        phone2_notes    =COALESCE(:phone2Notes, phone2_notes),
    ...
    @Query(
        ...
        phone1_notes=COALESCE(phone1_notes, :phone1Notes),
        phone2      =COALESCE(phone2, :phone2),
        phone2_notes=COALESCE(phone2_notes, :phone2Notes),
