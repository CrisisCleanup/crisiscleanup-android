...
# Clean and build
$GRADLEW clean
$GRADLEW bundleEarlybirdRelease
...
DIST_AAB=$DIST_DIR/app-earlybird-release.aab
MAPPING_FILE_NAME=release-aab-mapping.txt
cp $APP_OUT/bundle/earlybirdRelease/app-earlybird-release.aab $DIST_AAB
cp $APP_OUT/mapping/earlybirdRelease/mapping.txt $DIST_DIR/$MAPPING_FILE_NAME
