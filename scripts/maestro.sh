#! /usr/bin/env bash
# Script from https://github.com/dotanuki-labs/norris/blob/177e534e576a2457a2d579bfdccc6d7bea544234/scripts/maestro.sh
...
execute_tests_local() {
    ...
    echo
    for dir in "$maestro_workspace"/*/; do
        echo "Running tests under ${dir%/}"
        maestro test "$dir"
    done
}
